          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                if(widget.optional)
                  Text(" (${'optional'.tr})",style: textSemiBold.copyWith( fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),),
              ],
            ),
          ),
          ...
          decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                    ...
                    color: widget.borderColor ?? Theme.of(context).hintColor.withValues(alpha:widget.showBorder ? 0.2 : 0)),),
              ...
              errorBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(widget.borderRadius),
                borderSide: BorderSide(width: widget.showBorder ? 1 : 0, color: Theme.of(context).colorScheme.error.withValues(alpha:widget.showBorder ? 1 : 0)),),
              focusedErrorBorder : OutlineInputBorder(
                borderRadius: BorderRadius.circular(widget.borderRadius),
                borderSide: BorderSide(width: widget.showBorder ? 1 : 0, color: Theme.of(context).colorScheme.error.withValues(alpha:widget.showBorder ? 1 : 0)),),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(widget.borderRadius),
                borderSide: BorderSide(width: widget.showBorder ? 1 : 0, color: Theme.of(context).primaryColor.withValues(alpha:widget.showBorder ? 1 : 0) ),),
              ...
              contentPadding: EdgeInsets.symmetric(vertical: widget.maxLines > 1 ? 10 : 9,
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: SvgPicture.asset(widget.prefixIcon!,colorFilter: ColorFilter.mode(widget.prefixIconColor??
                      Theme.of(context).primaryColor, BlendMode.srcIn), height: widget.prefixIconSize??17,),
                ),
              ) : null),

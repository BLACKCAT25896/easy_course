...
class CustomButton extends StatelessWidget {
  const CustomButton({
    super.key, required this.onTap, required this.text, this.textColor =  Colors.black,
    this.height = 40, this.width = double.infinity, this.borderRadius = 5, this.showTextOnly = false,
    this.fontSize = 16, this.fontWeight = FontWeight.w500, this.icon, this.buttonColor,
  ...
  Widget build(BuildContext context) {
    return Container(decoration: BoxDecoration(
        ...
        color: (showBorderOnly == false) ?  (showTextOnly == false)? (buttonColor == null) ? onTap==null? Colors.grey.shade500 : Theme.of(context).secondaryHeaderColor : buttonColor :null : null,
              ...
              child: Row(mainAxisAlignment: buttonContentPosition,
                children: [if(iconPosition == IconPosition.left)...[
                  ...
                  if (text.isEmpty == false)
                    Flexible(child: FittedBox(child: Text(text, style: Get.textTheme.titleLarge!.copyWith(
